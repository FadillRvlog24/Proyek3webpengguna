...
<body>
    ...
    <h2 class="title">Shoes treatment</h2>
    <div class="layanan-list">
        <div class="layanan-item">
            <img src="{{ asset('img/quickclean.jpg') }}" alt="Quick Clean">
            <div class="text">
                <h4>Quick Clean <span class="price">20k/5 Jam</span></h4>
                <p>Pembersihan luar bagian sepatu termasuk sol dan upper</p>
            </div>
        </div>

        <div class="layanan-item">
            <img src="{{ asset('img/treatment_deepcleaning.jpg') }}" alt="Deep Clean">
            <div class="text">
                <h4>Deep Clean <span class="price">40k/3 Hari</span></h4>
                <p>Pembersihan menyeluruh bagian luar dan dalam sepatu, termasuk sol dan tali sepatu</p>
            </div>
        </div>

        <div class="layanan-item">
            <img src="{{ asset('img/sepatukulit.jpg') }}" alt="Leather Care">
            <div class="text">
                <h4>Leather Care <span class="price">55k/3 Hari</span></h4>
                <p>Pembersihan khusus untuk sepatu berbahan kulit, termasuk noda dan pemberian conditioner</p>
            </div>
        </div>

        <div class="layanan-item">
            <img src="{{ asset('img/kidsshoes.jpg') }}" alt="Kids Shoes Cleaning">
            <div class="text">
                <h4>Kids Shoes Cleaning <span class="price">20k/2 Hari</span></h4>
                <p>Pembersihan luar dan dalam untuk sepatu anak dengan size di bawah 34</p>
            </div>
        </div>

        <div class="layanan-item">
            <img src="{{ asset('img/sepatuwanita.jpg') }}" alt="Women Shoes"> 
            <div class="text">
                <h4>Women Shoes <span class="price">25k/2 Hari</span></h4>
                <p>Pembersihan khusus untuk sepatu wanita seperti high heels, flat shoes, dan wedges</p>
            </div>
        </div>

        <div class="layanan-item">
            <img src="{{ asset('img/unyellowing.jpg') }}" alt="Unyellowing Midsole">
            <div class="text">
                <h4>Unyellowing Midsole <span class="price">65k/4 Hari</span></h4>
                <p>Mengembalikan warna pada bagian midsole akibat oksidasi + Quick Clean</p>
            </div>
        </div>
